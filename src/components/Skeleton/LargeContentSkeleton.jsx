const LargeContentSkeleton = () => {
  return (
    <div className="flex flex-col w-full min-h-[70vh] gap-5 p-2 mx-auto bg-white shadow-lg select-none sm:p-4 sm:h-64 rounded-2xl sm:flex-row">
...
export default LargeContentSkeleton;
